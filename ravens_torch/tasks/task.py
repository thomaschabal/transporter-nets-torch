...
from ravens_torch.tasks import primitives
from ravens_torch.tasks.grippers import Suction
                ...
                for obj_id in obj_pts:
                    ...
                    if len(zone_size) > 1:
                        valid_pts = np.logical_and.reduce([
                            pts[0, :] > -zone_size[0] /
                            2, pts[0, :] < zone_size[0] / 2,
                            pts[1, :] > -zone_size[1] /
                            2, pts[1, :] < zone_size[1] / 2,
